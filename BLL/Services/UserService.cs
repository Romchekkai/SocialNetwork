...
namespace SocialNetwork.BLL.Services
{
    public class UserService
    {
        ...
        public void AddFriend(UserFriendsData userFriendsData)
        {
            var findUserEntity = userRepository.FindByEmail(userFriendsData.FriendEmail);
            if (findUserEntity is null) throw new UserNotFoundException();

            var friendEntity = new FriendEntity()
            {
                user_id = userFriendsData.UserId,
